...
function devmn_custom_scripts() {
    ...
    wp_enqueue_script('offer-item', get_template_directory_uri() . '/dist/js/offer-item.js', array(), '', true);
    ...
    wp_enqueue_script('product', get_template_directory_uri() . '/dist/js/product.js', array(), '', true);
...
function add_async_attribute($tag, $handle) {
    $scripts_to_async = array('lazybg', 'cubic', 'menu', 'offer-item');

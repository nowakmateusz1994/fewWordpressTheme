...
$posts = get_field('single_relation_items');
if (!$posts) {
...
?>
        <div class="home_posts_important_item">
            <a href="<?php the_permalink(); ?>" class="absolute"></a>
            <?php the_post_thumbnail('large'); ?>
            <div class="home_posts_important_item_contetn">
                <div class="home_posts_important_item_cats">
                    <?php
                ...
                <a href='<?= the_permalink(); ?>' class="home_posts_important_item_title"><?php the_title();  ?></a>
                <div class="meta">
    ...
    ?>
    <h3 class='section-title'><?= __('Nie znaleziono wpisów', 'devmn'); ?></h3>
<?php endif; ?>